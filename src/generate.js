// The single model-call boundary (#6). Architecture §5.6: "Every model call goes through one
// Function, which is also the boundary that lets the data posture in §6.4 stay switchable."
//
...
export async function generatePack(client, { clientName, clientNote, brief, cv } = {}) {
  ...
  // impossible, and a refusal or a truncation is not a pack.
